...
export default class Source extends React.Component {
    getSourceOption(source, addNumber) {
        if (source === Constants.SITE_LICHESS) {
            ...
            return <span>{addNumber?getNumberIcon('done', addNumber):null}{addNumber?<FontAwesomeIcon icon={faChessRook} className="lowOpacity" />:<Badge className="sourceName" color="info">New!</Badge>}<span className="sourceName"> Online tournaments</span></span>
        }
